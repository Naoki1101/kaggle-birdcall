...
def main():
    ...
    df = df[df['labels'].isin(['Trickle_and_dribble', 'Fill_(with_liquid)', 'Drip'])][df['length'] >= 3].reset_index(drop=True)
    ...
    sf.write('../data/input/example_noise/freesound_water_noise.wav', all_noise, samplerate=32_000)
